...
public class MainPageObject {
    ...
    public WebElement waitForElementAndSendKeys(String locator, String value, String error_mesage, long timeoutInSeconds) {
        WebElement element = waitForElementPresent(locator, error_mesage, timeoutInSeconds);
        new Actions(driver).moveToElement(element).click().sendKeys(value).perform();
        return element;
    }


    public boolean waitForElementNotPresent(String locator, String error_mesage, long timeoutInSeconds) {
    ...
    public void assertElementHasText(String locator, String expected, String error_mesage) {
        By by = this.getLocatorByString(locator);
    ...
    public void assertElementPresent(String locator, String attribute) {
        By by = this.getLocatorByString(locator);
        WebElement element = driver.findElement(by);

        Assert.assertEquals(element.getAttribute("text"), attribute);
    }
